        ...
        <StatusBar style="dark" />
            <InnerContainer>                 
                <WelcomeContainer>
                      ...
                      <Line />
                      <SubTitle question2={true}>Would you like to do a Questionnair?</SubTitle>
                    <StyledFromArea style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    <StyledButton onemin={true} onPress={() => router.replace('/Q_Onemin')}>
                        <ButtonText>One Min Test</ButtonText>
                    </StyledButton>
                    <StyledButton tenmin={true} onPress={() => router.replace('/Q_Fivemins')}>
                        <ButtonText>Five Mins Test</ButtonText>
                    </StyledButton>
                    </StyledFromArea>
                    <StyledFromArea>
                    <StyledButton style= {{backgroundColor: '#228B22', height: 100}} onPress={() => router.replace('/Q_Tenmins')}>
                            <ButtonText>Ten Mins Test</ButtonText>
                        </StyledButton>
                    </StyledFromArea>
                    <StyledFromArea>
                    <StyledButton style= {{backgroundColor: '#A9A9A9'}} onPress={() => router.replace('/Main')}>
