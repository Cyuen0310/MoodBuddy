        ...
        <Styledcontainer>
            ...
            <InnerContainer>
                <WelcomeContainer>
                    ...
                    <SubTitle>If you do this test before, you can enter your test result.</SubTitle>

                    <View style={styles.optionContainer}>
                        <TouchableOpacity onPress={() => handleSelect('A', 'I')}>
                            <Text style={[styles.dimensionText, mbti.A === 'I' && styles.selected]}>
                                I: Introversion
                            </Text>
                        </TouchableOpacity>
                        <Text style={styles.spacing}></Text>
                        <TouchableOpacity onPress={() => handleSelect('A', 'E')}>
                            <Text style={[styles.dimensionText, mbti.A === 'E' && styles.selected]}>
                                E: Extraversion
                            </Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.optionContainer}>
                        <TouchableOpacity onPress={() => handleSelect('B', 'S')}>
                            <Text style={[styles.dimensionText, mbti.B === 'S' && styles.selected]}>
                                S: Sensing
                            </Text>
                        </TouchableOpacity>
                        <Text style={styles.spacing}></Text>
                        <TouchableOpacity onPress={() => handleSelect('B', 'N')}>
                            <Text style={[styles.dimensionText, mbti.B === 'N' && styles.selected]}>
                                N: Intuition
                            </Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.optionContainer}>
                        <TouchableOpacity onPress={() => handleSelect('C', 'T')}>
                            <Text style={[styles.dimensionText, mbti.C === 'T' && styles.selected]}>
                                T: Thinking
                            </Text>
                        </TouchableOpacity>
                        <Text style={styles.spacing}></Text>
                        <TouchableOpacity onPress={() => handleSelect('C', 'F')}>
                            <Text style={[styles.dimensionText, mbti.C === 'F' && styles.selected]}>
                                F: Feeling
                            </Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.optionContainer}>
                        <TouchableOpacity onPress={() => handleSelect('D', 'J')}>
                            <Text style={[styles.dimensionText, mbti.D === 'J' && styles.selected]}>
                                J: Judging
                            </Text>
                        </TouchableOpacity>
                        <Text style={styles.spacing}></Text>
                        <TouchableOpacity onPress={() => handleSelect('D', 'P')}>
                            <Text style={[styles.dimensionText, mbti.D === 'P' && styles.selected]}>
                                P: Perceiving
                            </Text>
                        </TouchableOpacity>
                    </View>
