...
const questionsData: { questionText: string; options: Option[] }[] = [
    ...
    {
        questionText: "Question 18: When trying to understand something new, do you prefer?",
        options: [
    ...
    {
        questionText: "Question 27: When you think about the future, do you tend to focus on?",
        options: [
    ...
    {
        questionText: "Question 30: When reflecting on your experiences, do you prefer to focus on?",
        options: [
    ...
    {
        questionText: "Question 41: Do you find it easier to express yourself through?",
        options: [
    ...
    {
        questionText: "Question 45: When faced with a decision, do you rely more on?",
        options: [
    ...
    {
        questionText: "Question 47: In your leisure time, do you prefer activities that are?",
        options: [
    ...
    {
        questionText: "Question 52: In your daily life, do you prefer routines that are?",
        options: [
    ...
    {
        questionText: "Question 65: When it comes to making decisions, do you prefer to?",
        options: [
