...
const LoginScreen = () => {
    ...
    <Styledcontainer>
        <StatusBar style="dark" />
            <InnerContainer>
            <PageLogo resizeMode="cover" source={require('./../assets/images/MB_logo.png')} />
...
const UserTextInput = ({label, icon, isPassword = false, hidePassword, setPassword, ...props }:
     { label: string; icon: ImageSourcePropType; isPassword?: boolean, hidePassword?: boolean;
        setPassword?: React.Dispatch<React.SetStateAction<boolean>>; }& TextInputProps) => {
    return (
    <View>
        <LeftIcon>
